...
import com.example.sample.fourth.model.ForthFragment;
...
//        transaction.replace(R.id.frame_layout_main, new SampleFragment3());
        transaction.replace(R.id.frame_layout_main, new ForthFragment());
        transaction.commit();
    }
